...
public class FriendDaoImpl extends MySQLDao implements FriendDao{
    ...
    public int acceptRequest(String user,String friend){
        ...
        // When you are parameterizing the update, remember that you need
        // to use the ? notation (so you can fill in the blanks later)
        try(PreparedStatement ps = conn.prepareStatement("update friends set status = true where friend1 = ? and friend2 = ?)")) {
            // Fill in the blanks, i.e. parameterize the update
            ps.setString(1, user);
            ps.setString(2, friend);
    ...
    public int declineRequest(String user,String friend){
        ...
        // When you are parameterizing the update, remember that you need
        // to use the ? notation (so you can fill in the blanks later)
        try(PreparedStatement ps = conn.prepareStatement("delete from friends where friend1 = ? and friend2 = ? and status = false)")) {
            // Fill in the blanks, i.e. parameterize the update
            ps.setString(1, user);
            ps.setString(2, friend);
    ...
    public int getAllRequests(String user){
        ...
        // When you are parameterizing the update, remember that you need
        // to use the ? notation (so you can fill in the blanks later)
        try(PreparedStatement ps = conn.prepareStatement("select friend1 from friends where friend2 = ? and status = false)")) {
            // Fill in the blanks, i.e. parameterize the update
            ps.setString(1, user);
    ...
    public int getAllFriends(String user){
        ...
        // When you are parameterizing the update, remember that you need
        // to use the ? notation (so you can fill in the blanks later)
        try(PreparedStatement ps = conn.prepareStatement("Select count(*) from friends where friend1 = ? and status = true)")) {
            // Fill in the blanks, i.e. parameterize the update
            ps.setString(1, user);
